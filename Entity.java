...
public abstract class Entity{
 ...
 /** maximum speed for a player for use in tournament */
  ...
  public boolean closeEnough ( Field field, Entity entity1, Entity entity2){
     if( Math.abs(Math.hypot( entity2.getX() - entity1.getX(), entity2.getY() - entity1.getY() )) <= field.ARMS_LENGTH ){
      return true;
    }
     return false;
  }
